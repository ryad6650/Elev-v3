...
function getGroupLabel(dateStr: string): string {
  ...
  const diffWeeks = Math.floor((monday.getTime() - date.getTime()) / (7 * 86400000));
  if (diffWeeks < 5) return `Il y a ${diffWeeks + 1} semaine${diffWeeks > 0 ? "s" : ""}`;
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div
                    ...
                    style={{ fontSize: "0.85rem", color: "var(--text-primary)", marginBottom: 2 }}
                  >
                  ...
                  <div className="flex gap-1.5 flex-wrap">
                    {w.duree_minutes != null && (
                      <span
                        ...
                        style={{ fontSize: "0.6rem", background: "var(--bg-card)", color: "var(--text-secondary)" }}
                      >
                        ⏱ {w.duree_minutes} min
                      </span>
                    )}
