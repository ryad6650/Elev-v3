...
| Variable           | Valeur                           | Usage                                 |
| ------------------ | -------------------------------- | ------------------------------------- |
| --accent           | #1B2E1D                          | Vert foncé — boutons, CTA, nav active |
| --accent-hover     | #162816                          | Hover boutons                         |
| --accent-bg        | rgba(27,46,29,0.15)              | Fond card accent                      |
| --accent-text      | #74BF7A (dark) / #2D6A32 (light) | Chiffres accentués                    |
| --accent-secondary | #2d4a2f                          | Variante intermédiaire                |
| --color-protein    | #74BF7A                          | Vert protéines                        |
| --color-carbs      | #936A4F                          | Brun glucides                         |
| --color-fat        | #C07858                          | Terracotta lipides                    |
| --success          | #22C55E                          | Validations                           |
| --danger           | #EF4444                          | Suppressions                          |

**Note** : les couleurs d'accent sont fixées (plus de personnalisation utilisateur).
